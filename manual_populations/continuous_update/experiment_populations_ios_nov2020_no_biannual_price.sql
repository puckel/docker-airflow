...
where
  ...
  and json_extract_path_text(metadata, 'iOS_nov2020noBiAnnualPriceExperiment', TRUE) != ''
...
drop table if exists ab_platform.experiment_populations_ios_nov2020_no_biannual_price
cascade;
