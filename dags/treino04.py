...
default_args = {
    ...
    "start_date": datetime(2020, 11, 15, 17),
...
get_data = BashOperator(
    task_id="get-data",
    bash_command='mkdir -p /usr/local/airflow/data && curl http://download.inep.gov.br/microdados/Enade_Microdados/microdados_enade_2019.zip -o /usr/local/airflow/data/microdados_enade_2019.zip',
    dag=dag
)
